...
function RecipePageImages({recipeArray}) {
  const classes = cx("recipe__page__images", {
    "recipe__page__images--showing": recipeArray.length === 0,
    "recipe__page__images--notShowing": recipeArray.length > 0
  });
  ...
  return (
    <div className={classes}>
      ...
      <div className="recipe__page__image__container">
        ...
        <h4 className="recipe__page__images__caption">
          <span className="recipe__page__images__span">
            How to achieve your #breakfastgoals <br /> (and photograph them
            for maximum likes)
          </span>
        </h4>
      </div>
